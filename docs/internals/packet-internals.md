...
> [Visibility & Packets](../systems/visibility-and-packets.md).
...
Text is converted with [`RichText`](services.md#supporting-utilities-util-config-codec). All sends
...
`syncedHiddenPairs` set. Full precedence table: [Visibility & Packets](../systems/visibility-and-packets.md#volume-visibility-policy-tags).
...
which is why it's off by default. This path backs [TagNPC](../systems/tag-npc.md) visibility.
...
[interaction bridge](trigger-extras.md#interaction-bridge).)
...
- [Visibility & Packets](../systems/visibility-and-packets.md) — creator-facing behavior.
- [Internals: Services](services.md) — `PlayerOverrideService`, `TargetingPreventionService`.
- [Configuration](../configuration.md#global-flags) — the gating flags.
