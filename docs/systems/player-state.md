...
[Developer API](../DEVELOPER_API.md) exposes every operation; the [`/hextras`](../commands.md) commands
...
- **Effects:** [`set_variable`](../effects.md#set_variable),
  [`add_variable`/`increment_variable`](../effects.md#add_variable--increment_variable),
  [`calculate_variable`](../effects.md#calculate_variable), [`remove_variable`](../effects.md#remove_variable).
- **Condition:** [`variable_condition`](../conditions.md#variable_condition).
...
- **API:** `setVariable`, `getVariableString`, `incrementVariable`, `snapshotVariables`, … (see
  [Developer API → Variables](../DEVELOPER_API.md#variables)).

`partyId` is the conventional variable used by the [group visibility policy](visibility-and-packets.md#volume-visibility-policy-tags).
...
- **Effects:** [`add_tag`](../effects.md#add_tag), [`remove_tag`](../effects.md#remove_tag).
- **Condition:** [`has_tag`](../conditions.md#has_tag) (supports `Invert`).
...
- **Effect:** [`apply_cooldown`](../effects.md#apply_cooldown) (`Name`, `Duration` seconds).
- **Condition:** [`cooldown_ready`](../conditions.md#cooldown_ready) — passes only when the cooldown is
  **not** active.
...
[`calculate_variable`](../effects.md#calculate_variable) and [`math_condition`](../conditions.md#math_condition)
evaluate a formula with the `ArithmeticExpression` engine. The formula string is
[template-resolved first](../string-templates.md) (so `{variable:...}` becomes a number), then evaluated.
...
[Architecture → lifecycle](../architecture.md#plugin-lifecycle) for the full cleanup chain.

## See also

- [Developer API](../DEVELOPER_API.md) — `Variables`, `Tags`, `Cooldowns` sections.
- [Commands](../commands.md) — `/hextras var`, `/hextras tag`, `/hextras cooldown`.
- [String Templates](../string-templates.md) — `{variable:…}`, `{hasTag:…}`.
