...
import org.hyzionstudios.hyextras.service.InteractionTriggerService;
...
public class HyExtrasPlugin extends JavaPlugin {
    ...
    protected void start() {
        ...
        getLogger().at(Level.INFO).log("HyExtras started — 22 effects and 8 conditions registered.");
    }
    ...
    private void logInteractionDebug(String message) {
        if (extrasConfig != null && extrasConfig.debugMode) {
            getLogger().at(Level.INFO).log("[HyExtras interaction] " + message);
        }
    }
